...
- This workspace copy is adapted for OpenClaw and lives at `workspace/skills/markdown-proxy/`.
- For article-style links, treat this as the first-choice skill before generic browser or web fetch flows.
- Priority examples: WeChat, Xiaohongshu, X/Twitter, Weibo, Feishu/Lark docs, Zhihu, and similar content pages.
- OpenClaw script paths use:
  - `python3 workspace/skills/markdown-proxy/scripts/fetch_weixin.py "<url>"`
  - `python3 workspace/skills/markdown-proxy/scripts/fetch_feishu.py "<url>"`
- Recommended archive path in this workspace: `workspace/inbox/generated/`.

...
metadata:
  {
    "openclaw":
      {
        "emoji": "🚪",
        "tags": ["feishu", "file", "transfer", "mcp", "upload", "send"]
      }
  }
---
...
**描述**: Upload and send any file to Feishu chat.
...
- **相对路径**: 相对于 workspace 目录 (`/home/node/.openclaw/workspace`)
- **绝对路径**: 直接使用完整路径
